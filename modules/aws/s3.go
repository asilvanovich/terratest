...
// GetS3BucketTagging fetches fetches the given bucket's tags and returns them as a string map of strings.
...
//  GetS3BucketTaggingE fetches fetches the given bucket's tags and returns them as a string map of strings.
